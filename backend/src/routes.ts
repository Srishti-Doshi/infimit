...
import { articleScopedCommentRoutes, commentModerationRoutes } from '@/modules/comments';
...
apiV1.use('/articles/:articleId/comments', articleScopedCommentRoutes);
apiV1.use('/comments', commentModerationRoutes);
